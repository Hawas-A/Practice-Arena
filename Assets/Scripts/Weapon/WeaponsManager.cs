...
public class WeaponSystem : MonoBehaviour
{
    ...
    private uint currentAmmo = 0;
    private float lastFireTime = -999f;

    private Weapon ActiveWeapon =>
        EquippedWeapons.Count > 0 ? EquippedWeapons[activeWeaponIndex] : null;
    ...
    public void EquipWeapon(Weapon weapon)
    {
        ...
        {
            activeWeaponIndex = 0;
            currentAmmo = (uint)weapon.MaxAmmo;
            lastFireTime = -999f;
        }
    }
    ...
    public void UnequipWeapon(Weapon weapon)
    {
        ...
        activeWeaponIndex = Mathf.Clamp(activeWeaponIndex, 0, EquippedWeapons.Count - 1);

        if (ActiveWeapon != null)
        {
            currentAmmo = (uint)ActiveWeapon.MaxAmmo;
            lastFireTime = -999f;
        }
        else
        {
    ...
    public void SwitchToWeapon(int index)
    {
        ...
        activeWeaponIndex = Mathf.Clamp(index, 0, EquippedWeapons.Count - 1);
